...
namespace Util.Sockets
{
    ...
    public class TcpSocketServer
    {
                ...
                _socket.BeginAccept(asyncResult =>
                {
                    try
                    {
                        ...
                        TcpSocketConnection newConnection = new TcpSocketConnection(newSocket, this, RecLength)
                        {
                            ...
                            HandleException = HandleException == null ? null : new Action<Exception, TcpSocketConnection>(HandleException)
                        };
                    ...
                    {
                        HandleException?.Invoke(ex, null);
                    }
                }, null);
            }
            catch (Exception ex)
        ...
        /// 异常处理程序
        /// </summary>
        public Action<Exception, TcpSocketConnection> HandleException
        {
            get
            {
        ...
        private Action<Exception, TcpSocketConnection> _handleException;
